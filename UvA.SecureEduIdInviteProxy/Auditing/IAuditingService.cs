...
public interface IAuditingService
{
    ...
    /// </summary>
    /// <param name="sourceIpAddress">The IP address of the request origin</param>
    ...
    Task LogInviteOperationAsync(string sourceIpAddress, string roleId, bool isSuccessful,  IReadOnlyCollection<string> emailAddresses);
}